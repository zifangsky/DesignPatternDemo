...
![抽象工厂模式的通用类图](https://gitee.com/uploads/images/2018/0517/153449_ca4c0ff4_737082.png "抽象工厂模式的通用类图")

抽象工厂模式是工厂方法模式的升级版本，在有多个业务品种、业务分类时，通过抽象工厂模式产生需要的对象是一种非常好的解决方式。我们来看看抽象工厂的通用源代码，首先有两个互相影响的产品线（也叫做产品族），例如制造汽车的左侧门和右侧门，这两个应该是数量相等的——两个对象之间的约束，每个型号的车门都是不一样的，这是产品等级结构约束的，我们先看看两个产品族的类图：

![抽象工厂模式的通用源码类图](https://gitee.com/uploads/images/2018/0517/153511_accb8b3e_737082.png "抽象工厂模式的通用源码类图")
